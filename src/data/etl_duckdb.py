...
data is never materialized into a pandas DataFrame here (see CLAUDE.md rule #2).

Target definition (CLAUDE.md rule #1):
...
SELECT
    *,
    ...
    -- Target: default_flag (NULL = still active, excluded from training per CLAUDE.md rule #1)
    CASE
